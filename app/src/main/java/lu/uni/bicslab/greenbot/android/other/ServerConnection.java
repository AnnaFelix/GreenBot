...
public class ServerConnection {
    ...
    public static void postRequestUserAccess(final Context mContext,final ServerConnectionListner mServerConnectionListner){//working
        ...
        String url = BASIC_URL+request_user_access;
        Log.e("url",""+url);
